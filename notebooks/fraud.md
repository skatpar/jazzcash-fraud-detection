...
The Spark Cluster and Clickhouse Cluster is running on two VM's with 188GB RAM Each and 32CPUs
...
```python
stats, percentiles, high_risk_count = display_query_results(result_df, similarity_threshold=0.85)
```
