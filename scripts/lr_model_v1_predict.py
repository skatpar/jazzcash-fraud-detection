...
class FraudInferenceEngine:
    ...
    def __init__(self, 
        ...
        """
        # Set default paths
        script_dir = '/root/research-dir/dev/jazzcash-fraud-detection/models'
    ...
    def _setup_logging(self):
        ...
        log_path = '/root/research-dir/dev/jazzcash-fraud-detection/models/{log_filename}'
...
def main():
    ...
    output_base_path = f"/root/research-dir/dev/jazzcash-fraud-detection/models/fraud_predictions_datewise_{timestamp}"
